<html>
    <head>
        <title>GDOC - Publication Policy</title>
    ...
    <body>
		...
		<div id="centerContent" style="margin:0pt auto;width:65%">
			<p style="font-size:14pt">GDOC Publication Policy</p>
				...
				<p>
				For tracking purposes, we ask that you submit copies of all publications and presentations using G-DOC tools and/or data to the G-DOC team by emailing <a href="mailto:gdoc-help@georgetown.edu">gdoc-help@georgetown.edu</a>.   G-DOC will issue periodic updates to users on successful research projects that utilize G-DOC tools and/or data. 	
