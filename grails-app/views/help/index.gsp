<html>
<head>
	<meta name="layout" content="faqLayout" />
	<title>G-DOC FAQ</title> 
	<style> 
	    <!--
		.section { width:100%; }
...
<div id="sect1Answers" class="section">
	<div class="answer">
		<a name="q1">
		<span>Q: </span>What is G-DOC, and how can it help me?</a><br />
		
		<p class="answerText"><span>A: </span>
		The Georgetown Database of Cancer (G-DOC) is a searchable, integrated database of various biomedical research data types such as tissue annotations, gene expression, genetic variation, clinical trials data, health service related population data, etc. </p>
		
		<p>As a biomedical researcher, you can use these bioinformatics tools to generate powerful and testable hypotheses, analyze experimental data, explore cellular signaling networks through integrated pathway browser, share knowledge, and collaborate with others in the field.  It allows researchers to more easily access and analyze clinical and experimental research data across trials and studies from multiple cancer types as well as generate ad hoc queries and customized reports. The combination of clinical and experimental data types enables both basic and translational scientific research.</p>
	...
	<div class="answer">
		<a name="q5">
		<span>Q: </span>Where do I begin after logging into G-DOC?</a><br />
		
		<p class="answerText"><span>A: </span>
		The easiest way to begin is to use the Google-like open search at the center-top of the page.  Just type in what you want, and G-DOC may be able to direct you to the right place.</p>
		<p>The second easiest and quickest way to start is to click on Quick Start on G-DOC homepage.</p>
		<p>This will present you with a comprehensive view, in the form of a color-coded bar diagram, of available data sources, criteria of data available for each data source, namely clinical, metabolomics, gene expression & copy number and the total number of patients for each of the criteria.   On this page, you can also filter data based on different criteria / molecular profiling or patient outcome for different cancer types.  </p>
	...
	<div class="answer">
		<a name="q6">
		<span>Q: </span>Help me understand the color-coded bar diagram on G-DOC Quick Start?</a><br />
	...
	<div class="answer">
		<a name="q7">
		<span>Q: </span>What is the most effective way to use the Quick Start page?</a><br />
		
		<p class="answerText"><span>A: </span>
		The easiest and quickest way to start is to click on Quick Start on G-DOC homepage.</p>
		<p>On the Quick Start page you have the option of searching for data based on the kind of data, namely clinical, metabolomics, gene expression & copy number. For instance, you can filter data for only gene expression by selecting gene expression in the drop-down menu in <b<i>>molecular profiling</i></b> and clicking on <b><i>Show data availability</i></b> for criteria. Only studies with gene expression data will be reflected in the color-coded bar diagram on the right side of the screen. <a href="#q6">See,“ Help me understand the color-coded bar diagram on G-DOC Quick Start”.</a></p>
		<p>The other quick search option on this page is to search by patient outcome for a specific disease / cancer type. Under <b><i>outcomes</i></b>, select a cancer type and an outcome: Relapse or Mortality.</p>
	</div>
	
	<div class="answer">
		<a name="q2">
		<span>Q: </span>How does the Quick Start "outcomes" feature work? What does it compare?</a><br />
		
		<p class="answerText"><span>A: </span>
		The Quick Start "outcomes" feature enables the user to get a quick understanding of the studies (Take the following example: cancer type="BREAST" and outcome= "RELAPSE"). Mouse over the horizontal bars for each study to get an overview of the data. When we click on the study name, two groups are created, which are:</p>
		<p>Group 1) No relapse within predetermined period OR no relapse at all (** Note that the predetermined period can be found when mousing over the horizontal bar **)

		<p>Group 2) Had relapse</p>
		
		<p>These groups will be automatically created, enabling the user to compare and analyze the groups with ease. More groups and analysis can be performed by using the "SEARCH" and "ANALYZE" features in GDOC.</p>
	</div>
	...
	<div class="answer">
		...
		<p class="answerText"><span>A: </span>
		You can search for a ligand of desired affinity within a specific range of molecular weight targeting the gene, protein or molecule of your interest and obtain their physical, chemical and structural characteristics. Additionally, you can also view the interaction between the ligand and target in 3D viewer.</p>
	...
	<div class="answer">
		<a name="q34">
		<span>Q: </span>How can I get my data into G-DOC?</a><br />
	...
	<div class="answer">
		<a name="q42">
		<span>Q: </span>What is the publication policy for G-DOC?</a><br />
...
<div>
   If you need assistance, please send detailed technical issues to the following address:
	<a href="mailto:gdoc-help@georgetown.edu?subject=Need assistance with 
