...
insert into OV_TCGA_2011_01.km_attribute (KM_ATTRIBUTE_ID, CENSOR_ATTRIBUTE_ID, CENSOR_VALUE_ID) 
values ( 
(select attribute_type_id from common.attribute_type where short_name = 'PLATINUM_FREE_SURVIVAL_MONTHS'), 
(select attribute_type_id from common.attribute_type where short_name = 'PLATINUM_STATUS'), 
(select attribute_vocabulary_id from common.attribute_vocabulary v, common.attribute_type t where t.attribute_type_Id = v.attribute_type_id and t.short_name = 'PLATINUM_STATUS' and v.term_meaning = 'RESISTANT') 
);
