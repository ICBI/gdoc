...
class SavedAnalysisTests extends GroovyTestCase {
	...
	void testSaveAnalysis() {
		...
		def analysis = new SavedAnalysis(type:AnalysisType.KM, analysis: data, author:user)
		analysis.save()
	...
	void testLoadAnalysis() {
		...
		def params = [pvalue: 0.1]
		def analysis = new SavedAnalysis(type:AnalysisType.KM, analysis: km , author:user)
		analysis.save()
